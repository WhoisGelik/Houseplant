...
include 'db.php';
$cactus = get_cactus_by_id($_GET['id']);
            ...
            <div class="container">
                ...
                <div class="cart-top">
                    ...
                    <div class="cart-sidebar">
                        ...
                        <div class="rating">
                        <span class="active"><img src="<?= $cactus['rating1']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $cactus['rating2']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $cactus['rating3']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $cactus['rating4']; ?>" alt=""></span>
                        <span><img src="<?= $cactus['rating5']; ?>" alt=""></span>
                        </div>
                        <div class="price">
                            <span>Цена</span> <b><?= $cactus['price']; ?> руб.</b>
                        </div>
                        <div class="price">
