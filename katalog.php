...
$info = [];
 if ($query = $db->query("SELECT * FROM cart")) {
...
<html lang="ru">
  <head>
    ...
    <script scr="https://code.jquery.com/jquery-33.3.1.min.js"></script>
  ...
  <body>
    <div class="wrapper">
        ...
        <section class="home-menu">
          <div class="container">
            <a  href="decor-list.php">Декоративно-лиственные</a>
            <a class="slide" href="cactus.php">Кактусы</a>
            <a class="slide" href="polez_rasteniya.php">Полезные растения</a>
          </div>
        </section>
        <section class="home-products">
          <div class="container">
              <h3 class="all_products"><span>Все товары</span></h3>
              <div class="products-wrapper">
              <?php foreach ($info as $data): ?>
                <div class="product">
                  <div class="img"> <img src="<?= $data['img']; ?>" alt=""></div>
                  <a href="/cart.php?id= <?= $data['id']; ?>" class="title"><?= $data['title']; ?></a>
                  <p class="description">
