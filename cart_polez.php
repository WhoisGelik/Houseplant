    ...
    <div class="wrapper">
        ...
        <section class="cart">
            <div class="container">
                ...
                <div class="cart-top">
                    <div class="cart-img">
                        <img src="<?= $polez['img']; ?>" alt="">
                    </div>
                    <div class="cart-sidebar">
                        <div class="title"><?= $polez['title']; ?></div>
                        <div class="rating">
                        <span class="active"><img src="<?= $polez['rating1']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $polez['rating2']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $polez['rating3']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $polez['rating4']; ?>" alt=""></span>
                        <span><img src="<?= $polez['rating5']; ?>" alt=""></span>
                        </div>
                        <div class="price">
                            <span>Цена</span> <b><?= $polez['price']; ?> руб.</b>
                        </div>
                        <div class="price">
                        ...
                        <span class="min button">
                            ...
                            <input type="text" name="qty" id="qty" maxlength="10"/>
