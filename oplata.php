       ...
       <section class="dostavka-content">
        <div class="container">
            <div class="dostavka-content-wrapper">
                <h1>Оплата</h1>
                    <p>1. Перевод по реквизитам на карту сбербанка (онлайн).</p>
                    <p>2. Оплата банковской картой Visa, MasterCard, МИР.</p>
                    <p>3. Перевод на ИП по реквизитам.</p>   
                    <p>4. Наличными при доставке курьером или самовывозе.</p>
                    <p class="p2">
                    ВНИМАНИЕ! Для некоторых заказов требуется предоплата в размере от 50% до 100%. <br>
                    По 100% предоплате отгружаются заказы со срочной доставкой (в день согласования), с услугой пересадки растения, <br> с доставкой ТК по России и при оформлении доставки НЕ на следующий день (для резерва растений). Предоплата в размере 50% требуется для заказов на условиях самовывоза и крупных заказов (свыше 30000 рублей).
                    </p>
                    <div class="d-flex">
                        <a href="" class="green-btn" ><span>В каталог</span></a>
                        <a href="dostavka.php" class="default-btn"><span>Об доставке</span><img src="img/icon-next.svg" alt="" width="17px" height="15px"></a>
                    </div>
            </div>
        </div>
       </section>
