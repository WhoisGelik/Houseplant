    ...
    <div class="wrapper">
        ...
        <section class="cart">
            <div class="container">
                ...
                <div class="cart-top">
                    <div class="cart-img">
                        <img src="<?= $decor['img']; ?>" alt="">
                    </div>
                    <div class="cart-sidebar">
                        <div class="title"><?= $decor['title']; ?></div>
                        <div class="rating">
                        <span class="active"><img src="<?= $decor['rating1']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $decor['rating2']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $decor['rating3']; ?>" alt=""></span>
                        <span class="active"><img src="<?= $decor['rating4']; ?>" alt=""></span>
                        <span><img src="<?= $decor['rating5']; ?>" alt=""></span>
                        </div>
                        <div class="price">
                            <span>Цена</span> <b><?= $decor['price']; ?> руб.</b>
                        </div>
                        <div class="price">
