...
$info = [];
 if ($query = $db->query("SELECT * FROM polez_rasteniya")) {
  ...
  <body>
    <div class="wrapper">
        ...
        <section class="home-products">
          <div class="container">
              <h3 class="all_products"><span>Полезные растения</span></h3>
              <div class="products-wrapper">
              <?php foreach ($info as $data): ?>
                <div class="product">
                  <div class="img"> <img src="<?= $data['img']; ?>" alt=""></div>
                  <a href="/cart_polez.php?id= <?= $data['id']; ?>" class="title"><?= $data['title']; ?></a>
                  <p class="description">
